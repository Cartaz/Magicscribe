"""Static guardrails for the permanent KDE/Wayland desktop regression gate."""
...
def test_local_desktop_gate_captures_required_evidence() -> None:
    ...
    assert "issue #24" not in source
    assert "PR #25" not in source
    assert "GATE: PASS — nessun FAIL/SKIP." in source
