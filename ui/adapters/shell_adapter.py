"""API QML minimale per shell, shortcut e lifecycle."""
...
class ShellAdapter(QObject):
    ...
    def controlLogoCenterX(self) -> float:
        return self._coordinator.control_logo_center().x()

    @Property(float)
    def controlLogoCenterY(self) -> float:
        return self._coordinator.control_logo_center().y()
    ...
    def set_control_input_region(
        ...
        self._coordinator.set_control_input_region(x, y, width, height)
    ...
    def set_floating_input_region(
        ...
        self._coordinator.set_floating_input_region(x, y, width, height)
